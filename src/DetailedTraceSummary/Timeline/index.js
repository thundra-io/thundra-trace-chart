...
class Timeline extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      JSON.stringify(prevProps.activeSpanIds) !== JSON.stringify(this.props.activeSpanIds)
  ...
  render() {
    ...
    const { serviceNameColumnWidth, spanNameColumnWidth, childrenClosedSpans, dataOpenedSpans } = this.state;
    ...
    return (
      <div className="timeline">
        ...
        {spans.map((span, index, spans) => {
          ...
          return (
            <div className="timeline-span-ref-wrapper" key={span.spanId} ref={this.spanRefs[span.spanId]}>
              <TimelineSpan
