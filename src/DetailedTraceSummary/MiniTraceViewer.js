    ...
    renderTicks() {
        ...
        for (let i = 0; i < NUM_TICKS; i += 1) {
            const label = formatDuration(
                (i / (NUM_TICKS - 1)) * traceSummary.duration
            )
            ...
            timeMarkers.push(
                ...
                >
                    <span
                        className={`mini-trace-viewer__time-marker-label ${portionClassName}`}
                    >
                        {label}
                    </span>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        {startTs ? (
                            <rect
                                width={`${
                                    (startTs / traceSummary.duration) * 100
                                }%`}
                                height={GRAPH_HEIGHT}
                                x="0"
                                y="0"
